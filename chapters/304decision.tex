...
\begin{e1}
	...
	\itemt{Demande de \gls{cas} planifiée}{
		Une fois que les planificateurs ont analysé la mission et sont familiers avec ses implications, la \gls{req} initiale devrait être rédigée (Cfr. \cruderef{annexc} pour le format de la \gls{req}).
