...
\fullref{annc} pour un exemple de \gls{req}.
...
\begin{e1}
	...
	Lorsqu'il envoie une \gls{req}, le \ja{} fournit également une update de la situation.} %TODO For more information on the situation update, see Chapter V “Execution,” paragraph 2b (3), “Situation Update.”
	\itemt{Format de la \gls{req}}{
	Les données de mission inclueront au minimum les lignes 20 à 28. \fullref{annc} pour le format complet d'une \gls{req}.}
\end{e1}
