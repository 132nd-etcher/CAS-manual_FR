...
\begin{e1}
	...
	\itemt{Navigation}{
		La navigation dans ce document se fait principalement via les liens cliquables.
		
		Les touches avant/arrière sur le côté gauche de la souris servent à rapidement sauter d'un point à l'autre du document (dernière page vue).
	}
