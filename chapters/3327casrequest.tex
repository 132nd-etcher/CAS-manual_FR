...
Cfr. \cruderef{datacard} pour le format de la \gls{req}.
...
\todo[inline]{For more information on the situation update, see Chapter V “Execution,” paragraph 2b (3), “Situation Update.”}
	...
	Les données de mission inclueront au minimum les lignes 20 à 28. Cfr. \cruderef{datacard} pour le format de la \gls{req}.}
\end{e1}
