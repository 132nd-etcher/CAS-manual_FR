...
\begin{e1}
	...
	\begin{e2}
		...
		\itemt{Support mutuel \gls{jtac}.}{
			En temps de guerre, si un appareil se fait abattre, c'est généralement par une menace dont il n'avais pas conscience.
...
\todo[inline]{p119 13. Considerations for Planning with Laser Guided and Inertial Aided Munitions}
