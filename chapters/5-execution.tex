...
\e
    \itemt{Création du briefing par le \gls{jtac}}{
    Lorsqu'une cible a été désignée par le \gls{gc}, le \gls{jtac} doit effectuer les tâches suivantes:}
    \ee
        	...
        	\eeee
				...
				\eeeee
					...
					\eeeeee
						...
						\ed
						\item \parbox[c]{\linewidth}{\important{Lors du marquage laser depuis le sol, un \gls{fah} sera obligatoirement donné, de manière à renforcer l'établissement de la géométrie correcte}}
					\ed}
